...
% Header 3, inline
\newcommand{\headerthreeinline}[2]{\vspace{-1.5em}\begin{basedescript}{\setlength{\leftmargin}{\tripleparindent}}\item[\hspace{\tripleparindent}\textbf{#1}]#2\end{basedescript}\vspace{0.1em}}
