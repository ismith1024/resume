...
% ProjectLine
\newcommand{\projectLine}[2]{\vspace{-0.3em}\begin{basedescript}{\setlength{\leftmargin}{\tripleparindent}}\item[\hspace{\tripleparindent}\textbf{#1}]#2\end{basedescript}\vspace{-0.5em}}
...
\roottitle{Technical Skills}
    ...
    \inlineheadsection
    {Technologies:} {Python (Pandas, Requests, ScikitLearn, NumPy, Flask), SQL, Java, Javascript, R, Jupyter Notebooks}
    \inlineheadsection
    {Applications:}{ Data pipelines and ETL, Web scraping, Machine learning, Natural language processing, Web apps,
...
\headedsection
    ...
    \headedsubsection
        ...
        {Pending} 
        {\bodytext{CRISP-DM PRocess, Supervised learning, Unsupervised Learning, Deep Learning, Stakeholder Communication, Experimental Design, Software Engineering, ETL Pipelines, NLP Pipelines }} 
}
...
\headerone{Professional Projects}
   ...
   \projectLine{Purpose: }{ Analyze a client's supply chain for material risks.  Machine learning algorithm determines the types of materials based on text.  Renders a tabular report with recommended testing plan or design revisions, to assist a material science SME.  For a complex product, this allows a client to apply chemical testing in a cost-effective manner.}
   \projectLine{Results: }{Reduced a multi-week engineering workflow to hours.  XXX successful customer-projects to date.}
   \projectLine{Technology: }{Python, SQL, Javascript}

    
  \headertwo{Material Risk Knowledge Base}         
   \projectLine{Purpose: }{Periodically mines product recall and litigation repositories to obtain up-to-date chemical infraction data set.  Cleans and transforms raw HTML and XML, processes free text, and stores results in SQL repository.}
   \projectLine{Results: }{ Intertek maintains an industry-leading knowledge base on exactly what regulated chemicals are used, and in what types of products.} 
   \projectLine{Technology: }{Python (Pandas, Requests, NLTK), Java, SQL }

   
   \headertwo{ETL Pipelines }         
   \projectLine{Purpose: }{Automates customers' product design encodings and results of conformity assessments from various sources.  Maps schemas, cleans data, stores in engineering SQL database}
   ...
   \projectLine{Technology: }{Python, SQL}
