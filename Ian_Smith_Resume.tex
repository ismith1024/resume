...
\noindent
%\begin{itemize}
I currently lead a reasearch team within Intertek's Kanata office which enables the Global Restricted Substances (\acr{GRS})
...
\headedsection
    ...
    \headedsubsection
        ...
        {2012 -- 2018}
        {\bodytext{Data management, \acr{AI}, and software engineering.  Web and mobile application development. Computer Vision.  Named to Dean's List in 2016 and 2017.}}
}
...
\roottitle{Technical Skills}
    ...
    \inlineheadsection
    {Academic experience only:}{\acr{R}, Swift, Prolog, \acr{LISP}, \acr{C}, Android } 
...
%%%%%%%%%%%%% Obligatory filler at the end
    
%\roottitle{Other}
%\inlineheadsection  
%  {Miscellaneous Skills:} {Technical writing,   \LaTeX,  graphic design, securities analysis.}
